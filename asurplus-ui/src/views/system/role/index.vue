<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="角色标识" prop="sign" :show-overflow-tooltip="true" width="150" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="角色标识" prop="sign">
          <el-input v-model="form.sign" placeholder="请输入角色标识" />
        </el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="openDataScope" width="500px" append-to-body>
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="角色标识">
          <el-input v-model="form.sign" :disabled="true" />
        </el-form-item>
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm('确认要"' + text + '""' + row.name + '"角色吗?', "警告", {
          ...
          return changeRoleStatus(row.id, row.status === 0 ? 1 : 0);
        }).then(() => {
