package com.asurplus.tool.utils;
...
public class VelocityUtils {
    ...
    public static VelocityContext prepareContext(GenTableVO genTable) {
        ...
        velocityContext.put("pathName", genTable.getTableName().replaceAll("_", "-"));
        ...
        velocityContext.put("datetime", DateUtils.getYmd());
    ...
    public static int getExpandColumn(GenTableVO genTable) {
        ...
        for (GenTableColumn column : genTable.getColumns()) {
            if (null != column.getIsList() && StringUtils.equals("1", column.getIsList())) {
                num++;
