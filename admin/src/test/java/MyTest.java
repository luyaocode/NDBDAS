...
//    @Autowired
//    private GatewayInfoMapper gatewayMapper;
//
//    @Test
//    public void test01() {
...
//        Socket socket = tcpConnection.connect("localhost", 9090).get();
//        if (null != socket) {
//            TcpConnection.send(socket, "0808 0000 0006 01 03 9c41 0001");
...
//    @Test
//    public void test14(){
//        QueryWrapper<GatewayInfo> eq = new QueryWrapper<GatewayInfo>().eq("ip", "localhost").eq("port", "10000");
//        GatewayInfo one = gatewayInfoService.getOne(eq);
//        log.info("one=="+one);
//    }
//
//}
