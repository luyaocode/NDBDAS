...
/**
 * 为redis cache key 统一加上前缀
 */
@Slf4j
public class RedisKeySerializerCache implements RedisSerializer<String> {
    ...
    public RedisKeySerializerCache() {
        this(Charset.forName("UTF8"));
    }

    public RedisKeySerializerCache(Charset charset) {
