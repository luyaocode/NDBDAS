...
public class HttpUtils {
    ...
    public static String sendPost(String url, String param) {
        ...
        try {
            ...
            conn.setRequestProperty("Accept-Charset", CommonConstants.UTF8);
            conn.setRequestProperty("contentType", CommonConstants.UTF8);
        ...
        try {
            ...
            while ((ret = br.readLine()) != null) {
                if (ret != null && !"".equals(ret.trim())) {
                    result.append(new String(ret.getBytes("ISO-8859-1"), CommonConstants.UTF8));
                }
            }
            log.info("recv - {}", result);
            conn.disconnect();
