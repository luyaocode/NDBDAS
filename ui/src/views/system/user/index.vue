              ...
              <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item command="handleResetPwd" icon="el-icon-key"
                    v-hasPermi="['system:user:reset']">重置密码</el-dropdown-item>
...
export default {
    ...
    return {
      ...
      rules: {
        account: [
          ...
          { min: 3, max: 20, message: '账户长度必须介于 3 和 20 之间', trigger: 'blur' }
        ],
        name: [
  ...
  created() {
    ...
    this.getParamValue("user.default.password").then(res => {
