<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="父级编码" align="center" prop="dictCode" />
      <el-table-column label="字典编码" align="center" prop="code" />
      <el-table-column label="字典名称" align="center" prop="name">
        <template slot-scope="scope">
          <span v-if="scope.row.listClass == '' || scope.row.listClass == 'default'">{{scope.row.name}}</span>
          <el-tag v-else :type="scope.row.listClass == 'primary' ? '' : scope.row.listClass">{{scope.row.name}}</el-tag>
        </template>
      </el-table-column>
...
import { listTypeSelect, getType } from "@/api/system/dict/type";
...
export default {
  ...
  methods: {
    ...
    resetQuery() {
      ...
      this.queryParams.dictCode = this.defaultDictType;
      this.handleQuery();
    },
    /** 新增按钮操作 */
    handleAdd() {
