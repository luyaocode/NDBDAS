<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="sign" label="权限标识" :show-overflow-tooltip="true"></el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item v-if="form.type != 'M'" label="权限标识">
              <el-input v-model="form.sign" placeholder="请输入权限标识" maxlength="100" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item v-if="form.type != 'F'" label="显示状态">
