<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['monitor:logininfor:del']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="账户" align="center" prop="account" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']" />
      ...
      <el-table-column label="时间" align="center" prop="createTime" sortable="custom" :sort-orders="['descending', 'ascending']" width="180">
        <template slot-scope="scope">
  ...
  methods: {
    ...
    handleExport() {
      this.$confirm('是否确认导出所有操作日志数据项?', "警告", {
          ...
          // 开始导出
          exportExcel("/monitor/sys-login-log/export", this.queryParams);
